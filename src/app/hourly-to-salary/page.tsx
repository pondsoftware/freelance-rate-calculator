...
const webAppJsonLd = {
  ...
  "@type": "WebApplication",
  name: "Hourly Rate to Salary Converter",
  description: "Convert your freelance hourly rate to an equivalent annual salary. Accounts for self-employment taxes, health insurance, retirement, PTO, and non-billable hours.",
  url: "https://freelancerates.net/hourly-to-salary",
